<template>
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        refers to Dwells AB, Box 15, 56121,Huskvarna.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to dwells, accessible from
        <a
          href="http://dwells-001-site3.itempurl.com/"
          rel="external nofollow noopener"
          target="_blank"
          >http://dwells-001-site3.itempurl.com/</a
        >
      </p>
    </li>
    <li>
  ...
  <ul>
    <li>By email: khalil.malla@dwells.se</li>
  </ul>
</template>
